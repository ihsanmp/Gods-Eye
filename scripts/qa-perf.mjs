...
try {
  ...
  const diag = () => page.evaluate(() => window.__mapMonitoring.getRenderGovernorDiagnostics?.()
  ...
  const detectionDefault = await page.evaluate(
    () => window.__mapMonitoring.styleManager.getDetectionState?.() || null,
  );
  check(
  ...
  await page.evaluate(() => { window.__mapMonitoring.styleManager._setDetectionMode('OFF'); });
  ...
  await page.evaluate(() => { window.__mapMonitoring.styleManager._setDetectionMode('DENSE'); });
  ...
  await page.evaluate(() => { window.__mapMonitoring.styleManager.setStyle('retro'); });
  ...
  await page.evaluate(() => { window.__mapMonitoring.styleManager.setStyle('normal'); });
  ...
  const detectionStillOn = await page.evaluate(
    () => window.__mapMonitoring.styleManager.getDetectionState?.()?.detectionMode || null,
  );
  check(
  ...
  await page.evaluate(async () => {
    await window.__mapMonitoring.dataManager.setEnabled('satellites', true, { origin: 'user' });
  });
  const dSat = await diag();
  check('satellites enable registers its holder', dSat?.holds.includes('satellites'), dSat);
  await page.evaluate(async () => {
    await window.__mapMonitoring.dataManager.setEnabled('satellites', false, { origin: 'user' });
  });
  ...
  await page.evaluate(async () => {
    await window.__mapMonitoring.dataManager.setEnabled('flights', true, { origin: 'user' });
  });
  ...
  await page.evaluate(async () => {
    await window.__mapMonitoring.dataManager.setEnabled('flights', false, { origin: 'user' });
  });
