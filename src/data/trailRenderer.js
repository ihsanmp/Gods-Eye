...
// plane being tracked. Claiming the 'mm-trail:' id namespace makes
...
registerPickOwner('trails', (pickedId) => String(pickedId).startsWith('mm-trail:'));
