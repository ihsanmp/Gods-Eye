...
export const LAYER_STATE_REGISTRY = Object.freeze([
  ...
  Object.freeze({ id: 'day-night', token: 'n', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'maritime-chokepoints', token: 'k', disposition: 'enabled-only' }),
  Object.freeze({ id: 'maritime-ports', token: 'p', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'nuclear-sites', token: 'y', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'severe-weather', token: 'h', disposition: 'enabled-only' }),
  Object.freeze({ id: 'telegeography-submarine-cables', token: 'u', disposition: 'enabled-only' }),
  Object.freeze({ id: 'traffic', token: 't', disposition: 'enabled-only' }),
  Object.freeze({ id: 'volcanoes', token: 'o', disposition: 'enabled-only' }),
  Object.freeze({ id: 'world-events', token: 'v', disposition: 'enabled-only' }),
]);
